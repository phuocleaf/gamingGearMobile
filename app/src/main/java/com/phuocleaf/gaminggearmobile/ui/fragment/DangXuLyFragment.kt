...
import com.phuocleaf.gaminggearmobile.databinding.FragmentDangXuLyBinding
...
class DangXuLyFragment : Fragment() {

    private lateinit var reviewDonHangViewModel: ReviewDonHangViewModel
    private lateinit var binding: FragmentDangXuLyBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDangXuLyBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        reviewDonHangViewModel.getReviewOrder(userId,"Đang xử lý")
        observerLiveData()
    }
